...
exports.configure_store = function (options){return configure_store(options) };
exports.configure_session = function (store, options){return configure_session(store, options) };

/* private */
function configure_store(options) {
...
function configure_session(store, options) {
